 ...
 * **cv32e40p_ex_stage.sv** : Execution stage: Hosts ALU MAC anf FPU units.<br>
    ...
    * APU_DISP: offloads instructions to the shared unit (see cv32e40p_apu_disp.sv); <br>Parameters SHARED_DSP_MULT, SHARED_INT_DIV allow to offload also dot-product, int-div, int-mult to the shared unit.<br>
